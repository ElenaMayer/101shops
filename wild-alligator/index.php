...
<head>
   ...
   <script type="text/javascript">
      $jsonData = {
         "product":{
            "id":1016,
            "name":"Портмоне Wild Alligator",
            "title":"Портмоне Wild Alligator",
            "short_description":"Портмоне «Wild Alligator» - это безупречное качество, дорогой внешний вид и практичность.",
            "full_description":"Портмоне «Wild Alligator» - это безупречное качество, дорогой внешний вид и практичность."
         },
         "prices":{
            "271":{
               "price":2490,
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
               <div class="form_order">
                  <hgroup>
                     <div><img src="img/logo_.png" alt=""></div>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-md-8 col-sm-8">
                  ...
                  <div class="top_new_scheme">
                     <div class="braslet"><img src="img/main_.jpg" alt=""></div>
      ...
      <section class="order" id="order">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 col-sm-8">
                  <hgroup>
                     <h2>Отличная идея <span>для подарка</span><img class="order_img" src="img/h2_img.png" alt=""></h2>
                  </hgroup>
                  <div>
      ...
      <section class="photo" id="photo">
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="row">
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0510.jpg"><img src="img/0510.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0508.jpg"><img src="img/0508.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0509.jpg"><img src="img/0509.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0501.jpg"><img src="img/0501.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0502.jpg"><img src="img/0502.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0503.jpg"><img src="img/0503.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0504.jpg"><img src="img/0504.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0505.jpg"><img src="img/0505.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0506.jpg"><img src="img/0506.jpg" alt=""></a></div>
                  <div class="col-md-2 col-xs-6 col-sm-4"><a class="swipebox" rel="group" href="img/0507.jpg"><img src="img/0507.jpg" alt=""></a></div>
               </div>
            </div>
         </div>
      </section>
