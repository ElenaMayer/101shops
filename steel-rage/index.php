...
<html>
	<head>
		...
		<script type="text/javascript"> (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter38585960 = new Ya.Metrika({ id:38585960, clickmap:true, trackLinks:true, accurateTrackBounce:true }); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks"); </script> <noscript><div><img src="https://mc.yandex.ru/watch/38585960" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
		<!-- /Yandex.Metrika counter -->
		...
		<script type="text/javascript" src="js/form.custom.js?v=4"></script>
	...
	<body>
		...
		<section class="header" id="head">
			<section class="header2">
				<h1 id="tissot">
					<span class="header2-txt">Браслет Steel</span>
					<span class="header3-txt">Rage</span>
					<br>Настоящий мужской аксессуар, который<br> подчеркнет Ваш статус и индивидуальность!
				</h1>
				<div class="watch">
				...
				<div class="price">
					<p>ЦЕНА<br><span class="txt-price1">
							<span class="price_land_s4">3980</span>
							<span class="price_land_curr">руб.</span>
						</span><br>
						<span class="txt-price2">
							<span class="price_land_s1">1990</span>
						</span>
					</p>
				</div>
				<div class="form">
					...
					<div class="k_qst_div_31">
						...
						<form method="POST" action="<?= MAIN_DOMAIN ?>order.php" class="Stage1_form1" id="contact1" >
							...
							<input name="item_name" value="Steel Rage" type="hidden"/>
							<input name="item_price" value="1990" type="hidden"/>
					...
					<div class="timer">
						<div class="eTimer">
							<div class="etTitle">ДО КОНЦА АКЦИИ ОСТАЛОСЬ:</div>
			...
			<div class="block1">
				...
				<div class="container">
					...
					<p style="font-size:19px; line-height: 26px;"><b>Хирургическая сталь</b> - красивый металл с холодным блеском, который не окисляется, не темнеет, <br>
						очень прочный и простой в уходе. По блеску и яркости схож с серебром, но превосходит его по прочности.
					</p>
					<div class="div-steel">
						<p>Видео о нашем браслете</p><br>
		...
		<section class="opisanie">
			<div class="opisanie-block">
				<h1><span class="opisanie-txt">Почему же браслет Steel <span style="color: rgb(206, 127, 2);">Rage</span> <br> так популярен?</span></h1>
				...
				<div class="bullet-block animated mov">
					...
					<p><span>Уникальный дизайн</span> <br> Поражает своей неповторимой формой и уникальным дизайном. Кстати, яркие браслеты по праву занимают первое место в списке аксессуаров, которые кажутся девушкам наиболее сексуальными.</p>
				</div>
				<div class="bullet-block2 animated mov">
					<img src="img/tr2.png" height="200" width="200" alt="">
					<p><span>Хирургическая сталь</span> <br> Красивый и прочный металл, не уступающий драгоценным и даже превосходящий их по прочности и надёжности.</p>
				</div>
				<div class="bullet-block3 animated mov">
					<img src="img/tr1.png" height="200" width="200" alt="">
					<p><span>Золотое напыление</span> <br> Трехслойное золотое покрытие - красиво и долговечно.<br>Восхищенные взгляды окружающих Вам обеспечены!</p>
				</div>
			</div>
		</section>
		...
		<section class="six-prichin">
			<div class="six-prichin2">
				...
				<div id="2" class="six-block">
					...
					<div class="six-txt2">
						 <p><span class="six-txt1-1">Быстрая доставка</span> от 5 до 10 дней (Зависит от региона).</p>
					</div>
					<div class="six-txt3">
						<p>Гарантия на браслет - 1 год<br> <span class="six-txt1-1">Возврат в течении 14 дней!</span></p>
					</div>
					<div class="six-txt4">
						<p><span class="six-txt1-1">Оплата при получении!</span> Стоимость доставки 350 р.</p>
					</div>
					<div class="six-txt5">
						<p><span class="six-txt1-1">Доставим в ЛЮБОЙ</span> Регион России!</p>
					</div>
					<div class="six-txt6">
